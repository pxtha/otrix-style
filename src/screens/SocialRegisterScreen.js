...
function SocialRegisterScreen(props) {
    const [formData, setData] = React.useState({ firstName: null, lastName: null, email: null, mobileNumber: null, submited: false, type: null, message: null, loading: false, socialID: null, image: '', creation: '' });
    const [errors, setErrors] = React.useState({});
    const { firstName, lastName, mobileNumber, email, submited, type, creation, image, socialID, message, loading } = formData;

    useEffect(() => {
        const { s_email, s_socialID, s_image, s_firstName, s_lastName, s_creation } = props.route.params;
        setData({
            ...formData,
            email: s_email,
        ...
        <OtrixContainer>
            ...
            <OtrixContent>
                ...
                <FormControl style={{ backgroundColor: Colors().white }} isRequired isInvalid={submited && 'name' in errors}>
                    <Input variant="outline" placeholder="First Name" style={GlobalStyles.textInputStyle} value={firstName}
                ...
                <FormControl style={{ backgroundColor: Colors().white }} isRequired >
                    <Input variant="outline" placeholder="Last Name" style={GlobalStyles.textInputStyle} value={lastName}
...
export default connect(mapStateToProps, mapDispatchToProps)(SocialRegisterScreen);
