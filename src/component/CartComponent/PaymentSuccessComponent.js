        ...
        <View>
            ...
            <View style={styles.modelView}>
                ...
                <View style={styles.contentView}>
                    ...
                    <Text style={styles.paymentSuccess}>{strings.checkout.payment_confirm}</Text>
                    <OtrixDivider size={'lg'} />
                    <OtrixDivider size={'lg'} />
                    <Text style={styles.paymentDescTxt}>{strings.checkout.payment_desc}</Text>
                    <Button
                        size="md"
                        variant="solid"
                    ...
                    >
                        <Text style={GlobalStyles.buttonText}><Icon name="shopping-bag" size={wp('5%')} />  {strings.checkout.continue_shopping}</Text>
                    </Button>
                    {
                        auth && (
                            <Button
                                ...
                                <Text style={GlobalStyles.buttonText}><Icon name="smile" size={wp('5%')} />  {strings.checkout.view_order}</Text>
                            </Button>
                        )
                    }
