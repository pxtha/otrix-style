...
function CreditCartComponent(props) {
    const [formData, setData] = React.useState({ valid: false, cvc: null, number: null, expiry: null });
            ...
            <View style={styles.modelView}>
                ...
                <View style={styles.contentView}>
                    ...
                    <Button
                        ...
                        style={[GlobalStyles.button, { marginHorizontal: wp('4%'), top: hp('2%'), opacity: valid ? 1 : 0.7 }]}
                        onPress={() => valid ? props.payWithCard() : null}
                    >
                        <Text style={GlobalStyles.buttonText}><Icon name="credit-card" size={wp('5%')} />  Pay Now</Text>
                    </Button>
